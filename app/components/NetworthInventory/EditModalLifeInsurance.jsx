'use client'
import { API_BASE_URL } from '@/app/lib/libapi'
import axios from 'axios'
import React, { useEffect } from 'react'
import { FaPlusCircle, FaRegTrashAlt } from 'react-icons/fa'
import { IoMdClose } from 'react-icons/io'

const EditModalLifeInsurance = ({ isOpen, onClose, editData, handleChangeEditDataInputForm, handleBeneficiariesEditDataInputForm, addBeneficiariesEditDataForm, removeBeneficiariesEditDataInputForm, submitEditData }) => {
    return (
                    ...
                    <form className="mt-4 grid grid-cols-6 gap-6">
                        <div className="col-span-6">
                            ...
                            <input
                                ...
                                value={editData.insurance_company}
                                onChange={handleChangeEditDataInputForm}
                        ...
                        <div className="col-span-6 flex">
                            ...
                            <input
                                ...
                                name="policy_owner"
                                value={0}
                                checked={parseInt(editData.policy_owner) === 0}
                                onChange={handleChangeEditDataInputForm}
                                className='ml-2 mr-1'
                            />
                            ...
                            <input
                                ...
                                name="policy_owner"
                                value={1}
                                checked={parseInt(editData.policy_owner) === 1}
                                onChange={handleChangeEditDataInputForm}
                                className='ml-4 mr-1'
                            />
                        ...
                        <div className="col-span-6 ">
                            ...
                            <input
                                ...
                                value={editData.month_year_issued}
                                onChange={handleChangeEditDataInputForm}
                                className="mt-1 w-full rounded-md border border-gray-200 bg-white text-sm text-gray-700 shadow-sm p-2"
                            />
                        </div>
                        ...
                        <div className="col-span-6">
                            <label htmlFor="Beneficiaries" className="text-sm font-medium text-gray-700 mb-2 flex gap-2">
                                Beneficiaries <FaPlusCircle onClick={addBeneficiariesEditDataForm} className='text-lg cursor-pointer' />
                            </label>
                            {editData.beneficiaries?.map((item, idx) => (
                                <div key={idx} className='grid grid-cols-10 items-center gap-4 mb-1'>
                                    <div className="col-span-2">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleBeneficiariesEditDataInputForm(e, idx)}
                                            className="mt-1 w-full rounded-md border border-gray-200 bg-white text-sm text-gray-700 shadow-sm p-2"
                                        />
                                    </div>
                                    <div className="col-span-2">
                                    ...
                                    <div className="col-span-2">
                                        <button
                                            onClick={(e) => removeBeneficiariesEditDataInputForm(e, idx)}
                        ...
                        <div className="col-span-6">
                            <label htmlFor="guaranteedPayoutAccept" className="flex gap-4">
                                ...
                                <input
                                    ...
                                    value="1"
                                    checked={parseInt(editData.with_guaranteed_payout) === 1}
                                    onChange={handleChangeEditDataInputForm}
                        ...
                        <div className="col-span-6">
                            <label htmlFor="faceAmountforFamilyProtection" className="grid grid-cols-2 gap-2 items-center">
                                ...
                                <input
                                    ...
                                    value={editData.faceamount_fpcf}
                                    onChange={handleChangeEditDataInputForm}
                        ...
                        <div className="col-span-6">
                            <label htmlFor="faceAmountforEstateTax" className="grid grid-cols-2 gap-2 items-center">
                                ...
                                <input
                                    ...
                                    value={editData.faceamount_etax}
                                    onChange={handleChangeEditDataInputForm}
                                    className="w-32 p-2 rounded-md border border-gray-200 bg-white shadow-sm"
                                />
                            </label>
                        ...
                        <div className="col-span-6">
                            <label htmlFor="faceAmountforEstateDistribution" className="grid grid-cols-2 gap-2 items-center">
                                ...
                                <input
                                    ...
                                    value={editData.faceamount_edistribution}
                                    onChange={handleChangeEditDataInputForm}
                                    className="w-32 p-2 rounded-md border border-gray-200 bg-white shadow-sm"
                                />
                            </label>
                        ...
                        <div className="col-span-6">
                            <label htmlFor="totalFaceAmount" className="grid grid-cols-2 gap-2 items-center">
                                ...
                                <input
                                    ...
                                    value={editData.faceamount_total}
                                    onChange={handleChangeEditDataInputForm}
                                    className="w-32 p-2 rounded-md border border-gray-200 bg-white shadow-sm"
                                />
                            </label>
                        ...
                        <div className="col-span-6">
                            <label htmlFor="currentAccountValue" className="grid grid-cols-2 gap-2 items-center">
                                ...
                                <input
                                    ...
                                    value={editData.current_account_value}
                                    onChange={handleChangeEditDataInputForm}
                                    className="w-32 p-2 rounded-md border border-gray-200 bg-white shadow-sm"
                                />
                            </label>
...
export default EditModalLifeInsurance